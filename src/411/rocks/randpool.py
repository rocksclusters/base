...
__revision__ = "$Id: randpool.py,v 1.1 2007/12/10 21:28:33 bruno Exp $"
...
class RandomPool:
    ...
    def stir (self, s = ''):
        ...
        # back into the pool.
        for i in range(self.bytes / self._hash.digestsize):
        ...
        self._addPos, self._getPos = 0, self._hash.digestsize
        self.add_event()
